...
namespace hy_manipulation_controllers
{
    ...
    public:
        ...
        bool InterpolateTrajectory_pose(const Eigen::VectorXf &current_joints,
        ...
        void FitCubicSpline(const int n, const double dt[], const double x[], double x1[], double x2[]);

        void AdjustEndpointAccelerations(const int n, const double dt[], double x[], double x1[], double x2[]);
        ...
        bool ComputeTimeOptimalProfiles(
            std::vector<SparseWaypoint> &sparse_waypoints,
    ...
    private:
        ...
        KDL::Vector gravity_vector_; // 重力向量
